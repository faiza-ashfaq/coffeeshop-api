...
describe 'PUT api/v1/users/password/', { type: :request } do
  ...
  context 'with a valid token' do
    context 'with valid params' do
      ...
      include_examples 'have http status request', :ok
    ...
    context 'with invalid params' do
      ...
      include_examples 'have http status request', :unprocessable_entity
  ...
  context 'with an invalid token' do
    ...
    include_examples 'have http status request', :bad_request
