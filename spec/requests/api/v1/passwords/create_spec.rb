describe 'POST /api/v1/users/password', { type: :request } do
  ...
  context 'with an email' do
    context 'when the email exists' do
      ...
      include_examples 'have http status request', :no_content
    ...
    context 'when the email does not exist' do
      ...
      include_examples 'have http status request', :not_found
  ...
  context 'without an email' do
    ...
    include_examples 'have http status request', :unauthorized
  end
end
